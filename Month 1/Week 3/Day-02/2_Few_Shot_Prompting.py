...
=== EXAMPLES ===
Message: "The delivery courier threw my box over the gate and broke my lamp."
Classification: Complaint

Message: "Can you tell me if this keyboard is compatible with iPadOS?"
Classification: Question

Message: "The checkout process was super smooth, and I got my receipt instantly!"
...
print("\n Few-shot classification test successfully completed!")