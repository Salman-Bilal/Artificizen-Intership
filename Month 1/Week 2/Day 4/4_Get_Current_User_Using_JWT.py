"""
Question: 4: Write a get_current_user dependency that reads the Authorization: Bearer <token> header, decodes the JWT, and returns the user or raises 401.
...
oauth2_scheme = OAuth2PasswordBearer(tokenUrl="auth/token") # 🚨 Swagger looks here!
